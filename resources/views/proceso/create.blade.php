...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ 'Registrar Proceso' }}</h1>
...
<form action="{{ route('procesos.store') }}" method="POST">
	...
	<div class="container">
	  <div class="row g-4">
	    ...
	    <div class="col-12">
	    	@livewire('lista5-recorrido')
	    </div>
	    <div class="col-12">
	    	<label  class="form-label">{{ 'Tipo Envío' }}</label>
	      <input type="text" class="form-control" name="tipo_envio" value="{{ old('codigo_de_evento') }}">
	    </div>
	  </div>
	  <div class="mt-4">

...
<div class="container-fluid">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ 'Registrar PAF' }}</h1>
...
<form action="{{ route('paf.store') }}" method="POST">
	...
	<div class="container">
	  <div class="row g-4">
	    ...
	    <div class="col-12">
	    	<label class="form-label">{{ 'Código PAF' }}</label>
	      <input type="text" class="form-control"  name="codigo_paf" required="" value="{{ old('codigo_paf') }}">
	    </div>
	    <div class="col-12">
